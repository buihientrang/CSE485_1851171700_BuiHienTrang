                ...
                <section>
                    ...
                    <div class="px-20 py-16 border ">
                        <form action="edit-process.php" method="POST">
                            <?php 
                                include 'config.php';
                                $sql = "SELECT * FROM xethocba WHERE id =".$_GET['id'];
                                    ...
                                    <div>
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                và
                                                tên</label><input type="text" name="hoten" id="" value="<?php echo $row['hoten'] ?>"
                                        ...
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                sinh</label><input type="text" name="ngaysinh" id="" value="<?php echo $row['ngaysinh'] ?>"
                                        ...
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                <option value="<?php echo $row['hocluc12'] ?>">-Chọn-</option>
                                    ...
                                    <div>
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                <option value="<?php echo $row['gioitinh'] ?>">-Chọn-</option>
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            <div class="border border-gray-500 my-2">
                                                <label for="#"
                                                    ...
                                                    tộc</label>
                                                <input type="text" name="dantoc" id="" value="<?php echo $row['dantoc'] ?>" class="w-20 py-3 pl-1 outline-none"
                                            ...
                                            <div class="border border-gray-500 my-2">
                                                <label for="#"
                                                    ...
                                                    giáo</label>
                                                <input type=" text" name="tongiao" id="" value="<?php echo $row['tongiao'] ?>"class="w-20 py-3 pl-1 outline-none"
                                                    placeholder="Nhập tên" required>
                                            </div>
                                        </div>
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                tốt
                                                nghiệp</label><select name="namtn" id="" value="<?php echo $row['namtn'] ?>" class="py-3 pl-4 outline-none ">
                                        ...
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                kiểm
                                                lớp 12</label><select name="hanhkiem12" id="" value="<?php echo $row['hanhkiem12'] ?>" class="py-3 pl-4 outline-none ">
                                                <option value="#">-Chọn-</option>
                                ...
                                <div>
                                    <div class="grid grid-cols-3 gap-5">
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                CMND</label><input type="text" name="cmnd" id="" value="<?php echo $row['cmnd'] ?>"
                                        ...
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                cấp</label><input type="date" name="ngaycap" id="" value="<?php echo $row['ngaycap'] ?>"
                                        ...
                                        <div class="border border-gray-500 my-2">
                                            <label for="#"
                                                ...
                                                <option value="<?php echo $row['noicap'] ?>">-Chọn-</option>
                                                <option value="Tuyên Quang">Tuyên Quang</option>
                                                <option value="Vĩnh Phúc">Vĩnh Phúc</option>
                                                <option value="Hà Giang">Hà Giang</option>
                                                <option value="Hà Nội">Hà Nội</option>
                                    ...
                                    <div class="border border-gray-500 my-2">
                                        <label for="#"
                                            ...
                                            khẩu thường chú</label><input type="text" name="hktc" id="" value="<?php echo $row['hktc'] ?>"
                            ...
                            <div>
                                <div class="flex justify-between">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <div>
                                                <input type="text" name="matinh" id="" value="<?php echo $row['matinh'] ?>" required
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <div>
                                                <select name="tentinh" id="" value="<?php echo $row['tentinh'] ?>"
                                                    class="border border-gray-600 bg-gray-400  py-4 inline-block px-1 w-40 outline-none">
                                                    <option value="#">-Chọn Tỉnh-</option>
                                                    <option value="Tuyên Quang">Tuyên Quang</option>
                                                    <option value="Vĩnh Phúc">Vĩnh Phúc</option>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <div>
                                                <input type="text" name="matruong" id="" value="<?php echo $row['matruong'] ?>"required
                                                    class="border border-gray-600 bg-gray-400  py-4 inline-block px-1 w-40 outline-none">
                                            </div>
                                            <div>
                                                <input type="text" name="matruong" id="" value="<?php echo $row['matruong'] ?>"required
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <div>
                                                <select name="tentruong" id="" value="<?php echo $row['tentruong'] ?>"
                                                    class="border border-gray-600 bg-gray-400  py-4 inline-block px-1 w-40 outline-none">
                                                    <option value="#"></option>
                                ...
                                <div class="mt-6">
                                    <div>
                                        <label for="#">Đối tượng ưu tiên tuyển sinh (Thuộc đối tượng nào thí sinh chọn
                                            đối
                                            tượng
                                            bên phải)</label> <select name="dtuutien" id="" value="<?php echo $row['dtuutien'] ?>"
                                    ...
                                    <div class="flex justify-between mt-4">
                                        ...
                                        <select name="kvuutien" id="" value="<?php echo $row['kvuutien'] ?>"
                                ...
                                <div>
                                    <div class="border border-gray-500 my-4">
                                        <label for="#"
                                            ...
                                            chỉ liên hệ </label><input type="text" name="dclienhe" id="" value="<?php echo $row['dclienhe'] ?>" required
                                    ...
                                    <div class="grid grid-cols-2 gap-5">
                                        <div class="border border-gray-500 my-4">
                                            <label for="#"
                                                ...
                                                thoại thí sinh</label><input type="tel" name="sdtts" id="" value="<?php echo $row['sdtts'] ?>" required
                                                placeholder="Nhập số điện thoại" class=" py-3 pl-4  outline-none ">
                                        </div>
                                        <div class="border border-gray-500 my-4">
                                            <label for="#"
                                                class="border-r-2 border-gray-600 bg-gray-400  py-4 inline-block px-4">Điện
                                                thoại phụ huynh</label><input type="tel" name="sdtph" id="" value="<?php echo $row['sdtph'] ?>" required
                                                placeholder="Nhập số điện thoại" class=" py-3 pl-4  outline-none ">
                                        </div>
                                    </div>
                                </div>
